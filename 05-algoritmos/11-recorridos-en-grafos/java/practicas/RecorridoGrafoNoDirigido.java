...
public class RecorridoGrafoNoDirigido {
	...
	private final Map<Character, List<Character>> ady = new HashMap<>();
	...
	private void validarOrigen(char origen) {
		if (!ady.containsKey(origen)) {
			throw new IllegalArgumentException("El vertice de origen no existe: " + origen);
		}
	}
