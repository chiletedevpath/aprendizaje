Algoritmo Aumento_Sueldo_Categoria
	...
	Definir categoriaValida Como Logico
	categoriaValida = Verdadero
	...
	Segun categoria Hacer
		...
		De Otro Modo:
			categoriaValida = Falso
			Escribir " "
			Escribir "La categoria ",categoria " no existe"
	FinSegun

	Si categoriaValida Entonces
		Escribir " "
		Escribir "El trabajador tiene un aumento de S/ ", aumento
		Escribir "El sueldo final del trabajador es S/ ", SueldoFinal
	FinSi
